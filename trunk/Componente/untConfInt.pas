...
type
  ...
  private
    ...
    procedure setUsarOPMS(const Value: boolean);
  ...
  published
    ...
    property TissUsarOPMS:boolean read FUsarUsarOPMS write setUsarOPMS;
...
procedure TTissConfInt.setTissConfOutrasDesp(
